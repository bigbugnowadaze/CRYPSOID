...
ROOT=Path('test_v27_roundtrip')
OUT=ROOT/'outputs'; REP=ROOT/'reports'; TOOLS=ROOT/'tools'
if ROOT.exists(): shutil.rmtree(ROOT)
for d in [OUT,REP,TOOLS]: d.mkdir(parents=True,exist_ok=True)
SRC=Path('outputs/v25_attribute_group_render_container.3dphox')
V25_REPORT=Path('reports/PHOXBENCH_V25_ATTRIBUTE_GROUP_REPORT.json')
